...
const getBadgeFontSize = (text?: string) => {
  if (!text) return 5;
  if (text.length > 18) return 3.4;
        ...
        <g stroke="currentColor" fill="none" strokeWidth="0.4">
          ...
          <g>
            ...
            <text
              ...
              fill="white"
              stroke="none"
              fontSize={getBadgeFontSize(badgeTexts?.first)}
              fontWeight="500"
            >
          ...
          <g>
            ...
            <text
              ...
              fill="white"
              stroke="none"
              fontSize={getBadgeFontSize(badgeTexts?.second)}
              fontWeight="500"
            >
          ...
          <g>
            ...
            <text
              ...
              fill="white"
              stroke="none"
              fontSize={getBadgeFontSize(badgeTexts?.third)}
              fontWeight="500"
            >
          ...
          <g>
            ...
            <text
              ...
              fill="white"
              stroke="none"
              fontSize={getBadgeFontSize(badgeTexts?.fourth)}
              fontWeight="500"
            >
